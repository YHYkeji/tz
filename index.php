...
$isWechat = strpos($ua, 'MicroMessenger') !== false; // 微信检测
$isQQ = strpos($ua, 'QQ/') !== false || strpos($ua, 'MQQBrowser') !== false; // QQ检测

// 逻辑分支：微信或QQ访问显示HTML，其他直接跳转
if ($isWechat || $isQQ) {
    // 保留后续HTML输出
} else {
...
<title>精选影视丨小说丨动漫丨音乐黑科技资源</title>
